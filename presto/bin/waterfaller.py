...
def plot_waterfall(data, start, duration, 
                   ...
                   ax_im=None, ax_ts=None, ax_spec=None, interactive=True, language='english'):
    ...
    if language=='german':
        ax_im.set_xlabel("Zeit (Sek.)")
    else:
        ax_im.set_xlabel("Time (sec)")
    if language=='german':
        ax_im.set_ylabel("Radiofrequenz (MHz)")
    else:
...
#        rawdatafile = filterbank.filterbank(fn)
    ...
    plot_waterfall(data, start, options.duration, integrate_ts=options.integrate_ts, \
                   ...
                   sweep_posns=options.sweep_posns, language=options.language)
...
if __name__=='__main__':
    ...
    parser.add_option('--language', dest='language', \
                        help='Axis labels in a non-English language (Default: English)', default='english')
